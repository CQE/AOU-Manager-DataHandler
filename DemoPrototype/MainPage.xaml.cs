...
namespace DemoPrototype
{
        ...
        //Our class for handling chart data
    {
        public LineChartViewModel()
        {
            ...
            power.Add(new Power() { ElapsedTime = MyTime + 6, THotTank = 205, TCoolTank = 39, TReturnValve = 67, TReturnActual = 42, TReturnForecasted = 87 });
            power.Add(new Power() { ElapsedTime = MyTime + 7, THotTank = 204, TCoolTank = 38, TReturnValve = 57, TReturnActual = 46, TReturnForecasted = 61 });
            power.Add(new Power() { ElapsedTime = MyTime + 8, THotTank = 204, TCoolTank = 35, TReturnValve = 58, TReturnActual = 42, TReturnForecasted = 87 });
            power.Add(new Power() { ElapsedTime = MyTime + 9, THotTank = 214, TCoolTank = 31, TReturnValve = 59, TReturnActual = 41, TReturnForecasted = 63 });
            power.Add(new Power() { ElapsedTime = MyTime + 10, THotTank = 224, TCoolTank = 38, TReturnValve = 57, TReturnActual = 41, TReturnForecasted = 63 });
            power.Add(new Power() { ElapsedTime = MyTime + 11, THotTank = 220, TCoolTank = 45, TReturnValve = 37, TReturnActual = 42, TReturnForecasted = 87 });
            power.Add(new Power() { ElapsedTime = MyTime + 12, THotTank = 227, TCoolTank = 41, TReturnValve = 87, TReturnActual = 40, TReturnForecasted = 45 });
            power.Add(new Power() { ElapsedTime = MyTime + 13, THotTank = 235, TCoolTank = 37, TReturnValve = 77, TReturnActual = 41, TReturnForecasted = 44 });
            power.Add(new Power() { ElapsedTime = MyTime + 14, THotTank = 215, TCoolTank = 33, TReturnValve = 87, TReturnActual = 42, TReturnForecasted = 43 });
            power.Add(new Power() { ElapsedTime = MyTime + 15, THotTank = 204, TCoolTank = 40, TReturnValve = 77, TReturnActual = 43, TReturnForecasted = 42 });
            power.Add(new Power() { ElapsedTime = MyTime + 16, THotTank = 205, TCoolTank = 39, TReturnValve = 67, TReturnActual = 44, TReturnForecasted = 41 });
            power.Add(new Power() { ElapsedTime = MyTime + 17, THotTank = 204, TCoolTank = 38, TReturnValve = 57, TReturnActual = 45, TReturnForecasted = 40 });
